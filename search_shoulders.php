...
$sql = "SELECT workout_name, workout_type, workout_description FROM workouts WHERE workout_type = 'Shoulders' AND workout_name LIKE ?";
$searchTerm = '%' . $query . '%';
...
<head>
    <meta charset="UTF-8">
    <title>Shoulders Workouts</title>
    <style>
        body {
...
<button onclick="history.back()" class="back-button">⬅ Back</button>
    <div class="search-bar">
        <form method="GET" action="">
            <input type="text" name="query" placeholder="Search for shoulder workouts..." value="<?= htmlspecialchars($query) ?>">
