...
$sql = "SELECT workout_name, workout_type, workout_description FROM workouts WHERE workout_type = 'Biceps' AND workout_name LIKE ?";
$searchTerm = '%' . $query . '%';
...
<button onclick="history.back()" class="back-button">⬅ Back</button>
    <div class="search-bar">
        <form method="GET" action="">
            <input type="text" name="query" placeholder="Search for biceps workouts..." value="<?= htmlspecialchars($query) ?>">
